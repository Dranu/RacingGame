...
public class Car {
   ...
   // private int id;
    ...
    Car(GameSurface gamesurface, BufferedImage track, int ID) {
    ...
    public void initCar() {
        System.out.println("InitCar ID: " + id);
        try {
            //removed AsStream because it produced an error - Jiri
            if (id != 0){ 
            img = ImageIO.read(getClass().getResource("/resources/car1.png"));}
            else{img = ImageIO.read(getClass().getResource("/resources/car2.png"));}
